...
function QrCodeSection({ djProfile, onPrevious, isDarkMode }: {
    ...
    return (
        <Card className={`max-w-4xl mx-auto ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
            <CardHeader>
                <CardTitle className={`font-headline text-2xl flex items-center gap-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                    <QrCode /> Generar QR y Link
                </CardTitle>
                <CardDescription className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
                    Genera códigos QR únicos y links cortos para compartir tu formulario de solicitudes. Cada código es único y aleatorio.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                {/* URL del perfil */}
                <div className="space-y-3">
                    ...
                    {profileUrl && (
                        <div className={`p-3 rounded-lg text-sm ${isDarkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-50 text-blue-700'}`}>
                            <p className="font-medium mb-1">✨ Código único generado</p>
                            <p>Este link es único y aleatorio. Compártelo con seguridad en tus redes sociales.</p>
                        </div>
                    )}
                </div>
                ...
                {/* Código QR */}
                <div className="space-y-4">
                    <Label className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Código QR</Label>
                    ...
                    <div className="flex flex-col lg:flex-row gap-6 items-center">
                        ...
                        <div className={`flex-shrink-0 p-6 rounded-lg border ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'}`}>
                            {isGenerating ? (
                                <div className="w-64 h-64 flex items-center justify-center">
                                    <RefreshCw className={`w-8 h-8 animate-spin ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                                </div>
                            ) : qrCodeUrl ? (
                                ...
                                <div className={`w-64 h-64 flex items-center justify-center border-2 border-dashed rounded-lg ${isDarkMode ? 'border-gray-600 text-gray-400' : 'border-gray-300 text-gray-500'}`}>
                                    <div className="text-center">
                                        <QrCode className="w-12 h-12 mx-auto mb-2" />
                                        <p>QR se generará automáticamente</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex-1 space-y-4">
                            <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                                <h4 className={`font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>¿Cómo usar tu código QR único?</h4>
                                <ul className={`space-y-1 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                                    <li>• Cada código QR es único y aleatorio para tu seguridad</li>
                                    <li>• Imprime el código QR y colócalo en tu cabina de DJ</li>
                                    <li>• Comparte el link corto en tus redes sociales</li>
                                    <li>• Los usuarios escanean y acceden directamente a tu formulario</li>
                                    <li>• Puedes generar nuevos códigos cuando quieras</li>
                                </ul>
                            </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                    <Label className={`text-sm sm:text-base font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Compartir en redes sociales</Label>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                        {/* WhatsApp */}
                        <Button
                            variant="outline"
                            onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`¡Sígueme y envíame propinas! ${profileUrl}`)}`,'_blank')}
                            disabled={!profileUrl}
                            className="group relative overflow-hidden border-2 border-green-500 bg-green-50 hover:bg-green-500 text-green-700 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/25"
                        >
                        ...
                        <Button
                            variant="outline"
                            onClick={() => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(`¡Sígueme y envíame propinas! ${profileUrl}`)}`,'_blank')}
                            disabled={!profileUrl}
                            className="group relative overflow-hidden border-2 border-black bg-gray-50 hover:bg-black text-black hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-black/25"
                        >
                            <div className="flex items-center justify-center gap-2">
                                <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button
                            ...
                            disabled={!profileUrl}
                            className="group relative overflow-hidden border-2 border-blue-600 bg-blue-50 hover:bg-blue-600 text-blue-700 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-600/25"
                        >
                            <div className="flex items-center justify-center gap-2">
                                <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button
                            ...
                            disabled={!profileUrl}
                            className="group relative overflow-hidden border-2 border-pink-500 bg-gradient-to-br from-purple-50 to-pink-50 hover:from-purple-500 hover:to-pink-500 text-pink-600 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-pink-500/25"
                        >
                            <div className="flex items-center justify-center gap-2">
                                <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {/* Información adicional */}
                    <div className={`mt-4 p-3 rounded-lg text-xs sm:text-sm ${isDarkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-50 text-blue-700'}`}>
                        <p className="font-medium mb-1">💡 Consejo:</p>
                        <p>Comparte tu código QR en estas plataformas para que tus seguidores puedan enviarte propinas fácilmente.</p>
                    </div>
                </div>
